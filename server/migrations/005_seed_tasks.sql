...
VALUES
  ...
  ('requirements', 'Finalize requirements', 'Approved for the current build.', 2, TRUE, 5000, CURRENT_DATE + TIME '09:00', CURRENT_DATE + TIME '09:15', NOW(), NOW(), 1, nextval('task_revision_seq')),
  ('signal-drift', 'Analyze signal drift', '', 2, TRUE, 6000, CURRENT_DATE + INTERVAL '2 days', NULL, NOW(), NOW(), 1, nextval('task_revision_seq')),
  ...
  ('design-handoff', 'Prepare design handoff', '', 2, TRUE, 8000, CURRENT_DATE + INTERVAL '11 days', NULL, NOW(), NOW(), 1, nextval('task_revision_seq')),
  ('october-roadmap', 'Plan next month roadmap', '', 2, TRUE, 9000, CURRENT_DATE + INTERVAL '17 days', NULL, NOW(), NOW(), 1, nextval('task_revision_seq')),
